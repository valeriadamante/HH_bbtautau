...
namespace kin_fit {
    ...
    class FitProducer {
      public:
        ...
        static FitResults Fit(const LVector1& lepton1_p4,
                              const LVector2& lepton2_p4,
                              const LVector3& jet1_p4,
                              const LVector4& jet2_p4,
            ...
            return FitImpl(ConvertVector(lepton1_p4),
                           ConvertVector(lepton2_p4),
                           ConvertVector(jet1_p4),
                           ConvertVector(jet2_p4),
                           TVector2(Met_p4_converted.Px(), Met_p4_converted.Py()),
                           met_cov,
                           resolution_1,
                           resolution_2,
                           verbosity);
        }
        static FitResults FitImpl(const TLorentzVector& lepton1_p4,
                                  const TLorentzVector& lepton2_p4,
                                  const TLorentzVector& jet1_p4,
                                  const TLorentzVector& jet2_p4,
                                  const TVector2& met,
                                  const TMatrixD& met_cov,
                                  double resolution_1,
                                  double resolution_2,
                                  int verbosity) {
            FitResults result;
            try {
                HHKinFit2::HHKinFitMasterHeavyHiggs hh_kin_fit(
                    jet1_p4, jet2_p4, lepton1_p4, lepton2_p4, met, met_cov, resolution_1, resolution_2);
