...
f1 = ROOT.TFile.Open(
    "Studies/Triggers/files/genkind_distrib_0/gen_kinds_TTTo2L2Nu_tautau_Medium_Medium.root",
    "READ",
)
histo1 = f1.Get("tau1_gen_kind")
histo2 = f1.Get("tau2_gen_kind")
hist2D_1 = ROOT.TH2D(
    "tau1_tau2_genKind_VVLoose_0",
    "tau1_tau2_genKind_VVLoose_0",
    x_bins_vec.size() - 1,
    x_bins_vec.data(),
    x_bins_vec.size() - 1,
...
for x_bin_1 in range(0, histo1.GetNbinsX() + 1):
    for x_bin_2 in range(0, histo2.GetNbinsX() + 1):
        ...
        hist2D_1.Fill(
            histo1.GetBinCenter(x_bin_1), histo2.GetBinCenter(x_bin_2), content_1
        )
...
f2 = ROOT.TFile.Open(
    "Studies/Triggers/files/genkind_distrib_0/gen_kinds_TTTo2L2Nu_tautau_Medium_Medium_VSeLoose.root",
    "READ",
)
histo3 = f2.Get("tau1_gen_kind")
histo4 = f2.Get("tau2_gen_kind")
hist2D_2 = ROOT.TH2D(
    "tau1_tau2_genKind_Loose_0",
    "tau1_tau2_genKind_Loose_0",
    x_bins_vec.size() - 1,
    x_bins_vec.data(),
    x_bins_vec.size() - 1,
...
for x_bin_3 in range(0, histo3.GetNbinsX() + 1):
    for x_bin_4 in range(0, histo4.GetNbinsX() + 1):
        ...
        hist2D_2.Fill(
            histo3.GetBinCenter(x_bin_3), histo4.GetBinCenter(x_bin_4), content_2
        )
...
f3 = ROOT.TFile.Open(
    "Studies/Triggers/files/genkind_distrib_0/gen_kinds_TTTo2L2Nu_tautau_Medium_Medium_VSeVLoose.root",
    "READ",
)
histo5 = f3.Get("tau1_gen_kind")
histo6 = f3.Get("tau2_gen_kind")
hist2D_3 = ROOT.TH2D(
    "tau1_tau2_genKind_VLoose_0",
    "tau1_tau2_genKind_VLoose_0",
    x_bins_vec.size() - 1,
    x_bins_vec.data(),
    x_bins_vec.size() - 1,
...
for x_bin_5 in range(0, histo5.GetNbinsX() + 1):
    for x_bin_6 in range(0, histo6.GetNbinsX() + 1):
        ...
        hist2D_3.Fill(
            histo5.GetBinCenter(x_bin_5), histo6.GetBinCenter(x_bin_6), content_3
        )
...
f4 = ROOT.TFile.Open(
    "Studies/Triggers/files/genkind_distrib_1/gen_kinds_TTTo2L2Nu_tautau_Medium_Medium.root",
    "READ",
)
histo7 = f4.Get("tau1_gen_kind")
histo8 = f4.Get("tau2_gen_kind")
hist2D_4 = ROOT.TH2D(
    "tau1_tau2_genKind_VVLoose_1",
    "tau1_tau2_genKind_VVLoose_1",
    x_bins_vec.size() - 1,
    x_bins_vec.data(),
    x_bins_vec.size() - 1,
...
for x_bin_7 in range(0, histo7.GetNbinsX() + 1):
    for x_bin_8 in range(0, histo8.GetNbinsX() + 1):
        ...
        hist2D_4.Fill(
            histo7.GetBinCenter(x_bin_7), histo8.GetBinCenter(x_bin_8), content_4
        )
...
f5 = ROOT.TFile.Open(
    "Studies/Triggers/files/genkind_distrib_1/gen_kinds_TTTo2L2Nu_tautau_Medium_Medium_VSeLoose.root",
    "READ",
)
histo9 = f5.Get("tau1_gen_kind")
histo10 = f5.Get("tau2_gen_kind")
hist2D_5 = ROOT.TH2D(
    "tau1_tau2_genKind_Loose_1",
    "tau1_tau2_genKind_Loose_1",
    x_bins_vec.size() - 1,
    x_bins_vec.data(),
    x_bins_vec.size() - 1,
...
for x_bin_9 in range(0, histo9.GetNbinsX() + 1):
    for x_bin_10 in range(0, histo10.GetNbinsX() + 1):
        ...
        hist2D_5.Fill(
            histo9.GetBinCenter(x_bin_9), histo10.GetBinCenter(x_bin_10), content_5
        )
...
f6 = ROOT.TFile.Open(
    "Studies/Triggers/files/genkind_distrib_1/gen_kinds_TTTo2L2Nu_tautau_Medium_Medium_VSeVLoose.root",
    "READ",
)
histo11 = f6.Get("tau1_gen_kind")
histo12 = f6.Get("tau2_gen_kind")
hist2D_6 = ROOT.TH2D(
    "tau1_tau2_genKind_VLoose_1",
    "tau1_tau2_genKind_VLoose_1",
    x_bins_vec.size() - 1,
    x_bins_vec.data(),
    x_bins_vec.size() - 1,
...
for x_bin_11 in range(0, histo11.GetNbinsX() + 1):
    for x_bin_12 in range(0, histo12.GetNbinsX() + 1):
        ...
        hist2D_6.Fill(
            histo11.GetBinCenter(x_bin_11), histo12.GetBinCenter(x_bin_12), content_6
        )
...
f7 = ROOT.TFile.Open(
    "Studies/Triggers/files/genkind_distrib_2/gen_kinds_TTTo2L2Nu_tautau_Medium_Medium.root",
    "READ",
)
histo13 = f7.Get("tau1_gen_kind")
histo14 = f7.Get("tau2_gen_kind")
hist2D_7 = ROOT.TH2D(
    "tau1_tau2_genKind_VVLoose_2",
    "tau1_tau2_genKind_VVLoose_2",
    x_bins_vec.size() - 1,
    x_bins_vec.data(),
    x_bins_vec.size() - 1,
...
for x_bin_13 in range(0, histo13.GetNbinsX() + 1):
    for x_bin_14 in range(0, histo14.GetNbinsX() + 1):
        ...
        hist2D_7.Fill(
            histo13.GetBinCenter(x_bin_13), histo14.GetBinCenter(x_bin_14), content_4
        )
...
f8 = ROOT.TFile.Open(
    "Studies/Triggers/files/genkind_distrib_2/gen_kinds_TTTo2L2Nu_tautau_Medium_Medium_VSeLoose.root",
    "READ",
)
histo15 = f8.Get("tau1_gen_kind")
histo16 = f8.Get("tau2_gen_kind")
hist2D_8 = ROOT.TH2D(
    "tau1_tau2_genKind_Loose_2",
    "tau1_tau2_genKind_Loose_2",
    x_bins_vec.size() - 1,
    x_bins_vec.data(),
    x_bins_vec.size() - 1,
...
for x_bin_15 in range(0, histo15.GetNbinsX() + 1):
    for x_bin_16 in range(0, histo16.GetNbinsX() + 1):
        ...
        hist2D_8.Fill(
            histo15.GetBinCenter(x_bin_15), histo16.GetBinCenter(x_bin_16), content_8
        )
...
f9 = ROOT.TFile.Open(
    "Studies/Triggers/files/genkind_distrib_2/gen_kinds_TTTo2L2Nu_tautau_Medium_Medium_VSeVLoose.root",
    "READ",
)
histo17 = f9.Get("tau1_gen_kind")
histo18 = f9.Get("tau2_gen_kind")
hist2D_9 = ROOT.TH2D(
    "tau1_tau2_genKind_VLoose_2",
    "tau1_tau2_genKind_VLoose_2",
    x_bins_vec.size() - 1,
    x_bins_vec.data(),
    x_bins_vec.size() - 1,
...
for x_bin_17 in range(0, histo17.GetNbinsX() + 1):
    for x_bin_18 in range(0, histo18.GetNbinsX() + 1):
        ...
        hist2D_9.Fill(
            histo17.GetBinCenter(x_bin_17), histo18.GetBinCenter(x_bin_18), content_9
        )
...
####### printOuts ######
print(
    f"nEvents for VVLoose are : 0 = {histo1.GetEntries()}, 1 ={histo7.GetEntries()}, 2 = {histo13.GetEntries()} "
)
...
print(
    f"percentage for VVLoose are : 0 = {100*histo1.GetEntries()/total_VVLoose}, 1 ={100* histo7.GetEntries()/total_VVLoose}, 2 = {100*histo13.GetEntries()/total_VVLoose} "
)

print()
print(
    f"nEvents for Loose are : 0 = {histo3.GetEntries()}, 1 ={histo9.GetEntries()}, 2 = {histo15.GetEntries()}"
)
total_Loose = histo3.GetEntries() + histo9.GetEntries() + histo15.GetEntries()
print(f"total nEvents for Loose are : 0 = {total_Loose} ")
print(
    f"percentage for Loose are : 0 = {100*histo3.GetEntries()/total_Loose}, 1 ={100* histo9.GetEntries()/total_Loose}, 2 = {100*histo15.GetEntries()/total_Loose}"
)
print()
total_VLoose = histo5.GetEntries() + histo11.GetEntries() + histo17.GetEntries()
print(
    f"nEvents for VLoose are : 0 = {histo5.GetEntries()}, 1 ={histo11.GetEntries()}, 2 = {histo17.GetEntries()}"
)
print(
    f"total nEvents for VLoose are : 0 = {histo5.GetEntries() + histo11.GetEntries() + histo17.GetEntries()} "
)
print(
    f"percentage for VLoose are : 0 = {100*histo5.GetEntries()/total_VLoose}, 1 ={100* histo11.GetEntries()/total_VLoose}, 2 = {100*histo17.GetEntries()/total_VLoose}"
)
