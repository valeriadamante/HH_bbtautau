...
if __name__ == "__main__":
    ...
    for sample_name in sample_list:
        ...
        df_muTau = dfWrapped_central.df.Filter("muTau").Filter(
            "tau1_gen_kind==4 && tau2_gen_kind==5"
        )
        ...
        nInitial_muTau = (
            df_muTau.Define("total_weight_string", total_weight_string)
            .Sum("total_weight_string")
            .GetValue()
        )
        ...
        pass_singleTau_validity = (
            f"""HLT_singleTau && ({GetTrgValidityRegion("HLT_singleTau")})"""
        )
        ...
        pass_singleMu50_application = pass_other_trg_application.format(
            "HLT_singleMu50"
        )
        pass_mutau_validity = f"""HLT_mutau && ({GetTrgValidityRegion("HLT_mutau")})"""
        pass_singleMu_validity = (
            f"""HLT_singleMu && ({GetTrgValidityRegion("HLT_singleMu")})"""
        )
        pass_singleMu50_validity = (
            f"""HLT_singleMu50 && ({GetTrgValidityRegion("HLT_singleMu50")})"""
        )

        ##### validity triggers #####
        trg_muTau_list_validity_fullOR = [
            pass_mutau_validity,
            pass_singleMu_validity,
            pass_singleTau_validity,
            pass_MET_validity,
        ]
        trg_muTau_list_validity_fullOR_mu50 = [
            pass_mutau_validity,
            pass_singleMu_validity,
            pass_singleTau_validity,
            pass_MET_validity,
        ...
        trg_muTau_list_validity_legacy_singleTau = [
            pass_mutau_validity,
            pass_singleMu_validity,
            pass_singleTau_validity,
        ]
        trg_muTau_list_validity_legacy_MET = [
            pass_mutau_validity,
            pass_singleMu_validity,
            pass_MET_validity,
        ]
        trg_muTau_list_validity_legacy_MET_singleTau = [
            pass_mutau_validity,
            pass_singleMu_validity,
            pass_MET_validity,
            pass_singleTau_validity,
        ]
        trg_muTau_list_validity_legacy_singleMu50 = [
            pass_mutau_validity,
            pass_singleMu_validity,
            pass_singleMu50_validity,
        ]
        trg_muTau_list_validity_legacy = [
            pass_mutau_validity,
            pass_singleMu_validity,
        ]  # ratio denumerator

        ##### application triggers #####
        trg_muTau_list_application_fullOR = [
            pass_mutau_application,
            pass_singleMu_application,
        ...
        trg_muTau_list_application_legacy_singleTau = [
            pass_mutau_application,
            pass_singleMu_application,
            pass_singleTau_application,
        ]
        trg_muTau_list_application_legacy_MET_singleTau = [
            pass_mutau_application,
            pass_singleMu_application,
            pass_MET_application,
            pass_singleTau_application,
        ]
        trg_muTau_list_application_legacy_MET = [
            pass_mutau_application,
            pass_singleMu_application,
            pass_MET_application,
        ]
        trg_muTau_list_application_legacy_singleMu50 = [
            pass_mutau_application,
            pass_singleMu_application,
            pass_singleMu50_application,
        ]
        trg_muTau_list_application_legacy = [
            pass_mutau_application,
            pass_singleMu_application,
        ]  # ratio denumerator
        ...
        AddEfficiencyToDict(
            ...
            "muTau",
            nInitial_muTau,
            "eff_application_legacySingleTau",
            eff_mutau_application,
            eff_mutau_application_errors,
            args.wantNEvents,
        )
        ...
        AddEfficiencyToDict(
            dataframes_channel_bigTau[channel],
            trg_muTau_list_application_fullOR,
            "muTau",
            nInitial_muTau,
            "eff_application_fullOR_bigTau",
            eff_mutau_application_bigTau,
            eff_mutau_application_bigTau_errors,
            args.wantNEvents,
            True,
        ...
        AddEfficiencyToDict(
            ...
            "muTau",
            nInitial_muTau,
            "eff_application_legacySinglmuTau_bigTau",
            eff_mutau_application_bigTauOnly,
            eff_mutau_application_bigTauOnly_errors,
            args.wantNEvents,
        )
        ...
        AddEfficiencyToDict(
            ...
            "muTau",
            nInitial_muTau,
            "eff_application_legacyMET_bigTau",
            eff_mutau_application_bigTauOnly,
            eff_mutau_application_bigTauOnly_errors,
            args.wantNEvents,
        )
