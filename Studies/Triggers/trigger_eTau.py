...
if __name__ == "__main__":
    ...
    for sample_name in sample_list:
        ...
        df_eTau = dfWrapped_central.df.Filter("eTau").Filter(
            "tau1_gen_kind==3 && tau2_gen_kind==5"
        )
        ...
        nInitial_eTau = (
            df_eTau.Define("total_weight_string", total_weight_string)
        ...
        pass_singleEle_validity = (
            f"""HLT_singleEle && ({GetTrgValidityRegion("HLT_singleEle")})"""
        )

        ##### validity triggers #####
        trg_eTau_list_validity_fullOR = [
            pass_etau_validity,
            pass_singleEle_validity,
            pass_singleTau_validity,
            pass_MET_validity,
        ]
        trg_eTau_list_validity_legacy_singleTau = [
            pass_etau_validity,
            pass_singleEle_validity,
            pass_singleTau_validity,
        ]
        trg_eTau_list_validity_legacy_MET = [
            pass_etau_validity,
            pass_singleEle_validity,
            pass_MET_validity,
        ]
        trg_eTau_list_validity_legacy = [
            pass_etau_validity,
            pass_singleEle_validity,
        ]  # ratio denumerator

        ##### application triggers #####
        trg_eTau_list_application_fullOR = [
            pass_etau_application,
            pass_singleEle_application,
            pass_singleTau_application,
            pass_MET_application,
        ]
        trg_eTau_list_application_legacy_singleTau = [
            pass_etau_application,
            pass_singleEle_application,
            pass_singleTau_application,
        ]
        trg_eTau_list_application_legacy_MET = [
            pass_etau_application,
            pass_singleEle_application,
            pass_MET_application,
        ]
        trg_eTau_list_application_legacy = [
            pass_etau_application,
            pass_singleEle_application,
        ]  # ratio denumerator
        ...
        AddEfficiencyToDict(
            ...
            "eTau",
            nInitial_eTau,
            "eff_application_legacySingleTau_bigTau",
            eff_etau_application_bigTauOnly,
            eff_etau_application_bigTauOnly_errors,
            args.wantNEvents,
        )
